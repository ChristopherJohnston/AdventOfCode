    ...
    class Program
    {
        ...
        static void Part1() {
            ...
            foreach (int count in c) {
                ...
                float numOnes = (float)count/rowCount;

                gamma += (numOnes >= 0.5) ? '1' : '0';                
        ...
        static void Part2() {
            ...
            List<string> oxygens = input;
            List<string> scrubbers = input;

            int numPasses = 0;
            while (oxygenRating == string.Empty || scrubberRating == string.Empty)  {                                
